...
public class CarleeHibernateRunner {
    private List<User> users;
    private CarleeHibernateConfig theHibernateUtility;

    public CarleeHibernateRunner(){
        theHibernateUtility = new CarleeHibernateConfig();
    }

    public static void main(String[] args){

        CarleeHibernateRunner aSillyHibernateUseExample = new CarleeHibernateRunner();
